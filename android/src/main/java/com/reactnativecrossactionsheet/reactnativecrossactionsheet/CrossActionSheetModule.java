...
public class CrossActionSheetModule extends ReactContextBaseJavaModule {
  public static final String NAME = CrossActionSheetModuleImpl.NAME;
  private final ReactApplicationContext reactContext;
  private boolean isShowingDialog = false;
  BottomSheetDialog dialog;

  CrossActionSheetModule(ReactApplicationContext context, ReactApplicationContext reactContext) {
    super(context);
  ...
  public String getName() {
    return CrossActionSheetModuleImpl.NAME;
  }
